                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Imie</th><th>Email</th><th>Akcje</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($users as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/users/' . $item->id . '/edit') }}" title="Edytuj User"><button class="btn btn-primary btn-sm">
                                            ...
                                            <form method="POST" action="{{ url('/admin/users' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-danger btn-sm" title="Usuń User" onclick="return confirm('Confirm delete')">
